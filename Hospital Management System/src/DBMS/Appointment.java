...
public class Appointment {
    ...
    {
        //Date date=new Date(appointmentDate.getDate());
        ...
        // pst.setDate(3, date);
        // pst.setDate(3, new java.sql.Date(appointmentDate.getTime()));
        pst.setDate(3, sqlDate);
        // pst.setTime(4, new java.sql.Time(appointmentTime.getTime()));
